...
// node_modules/talib-web/lib/index.esm.js
var __INIT__ = function() {
  var _scriptDir = typeof document !== "undefined" && document.currentScript ? document.currentScript.src : void 0;
  if (typeof __filename !== "undefined")
    _scriptDir = _scriptDir || __filename;
  return function(__INIT__2) {
    __INIT__2 = __INIT__2 || {};
    var Module = typeof __INIT__2 !== "undefined" ? __INIT__2 : {};
    ...
    if (ENVIRONMENT_IS_NODE) {
      ...
      read_ = function shell_read(filename, binary) {
        if (!nodeFS)
          nodeFS = (init_fs(), __toCommonJS(fs_exports));
        if (!nodePath)
    ...
    function createWasm() {
      ...
      function receiveInstance(instance, module) {
        ...
        exports2 = relocateExports(exports2, 1024);
        Module["asm"] = exports2;
        var metadata = getDylinkMetadata(module);
        if (metadata.neededDynlibs) {
          dynamicLibraries = metadata.neededDynlibs.concat(dynamicLibraries);
        }
        mergeLibSymbols(exports2, "main");
    ...
    function loadWebAssemblyModule(binary, flags, handle) {
      ...
      function loadModule() {
        ...
        function postInstantiation(instance2) {
          updateTableMap(tableBase, metadata.tableSize);
          moduleExports = relocateExports(instance2.exports, memoryBase);
          if (!flags.allowUndefined) {
            reportUndefinedSymbols();
          }
          var init2 = moduleExports["__wasm_call_ctors"];
          if (init2) {
            if (runtimeInitialized) {
              init2();
            } else {
              __ATINIT__.push(init2);
            }
          }
    ...
    function loadDynamicLibrary(lib, flags, handle) {
      ...
      function getLibModule() {
        if (Module["preloadedWasm"] !== void 0 && Module["preloadedWasm"][lib] !== void 0) {
    ...
    var _TA_ACCBANDS = Module["_TA_ACCBANDS"] = function() {
      return (_TA_ACCBANDS = Module["_TA_ACCBANDS"] = Module["asm"]["TA_ACCBANDS"]).apply(null, arguments);
    };
    ...
    var _TA_SMA = Module["_TA_SMA"] = function() {
      return (_TA_SMA = Module["_TA_SMA"] = Module["asm"]["TA_SMA"]).apply(null, arguments);
    };
    var _TA_ACOS = Module["_TA_ACOS"] = function() {
      return (_TA_ACOS = Module["_TA_ACOS"] = Module["asm"]["TA_ACOS"]).apply(null, arguments);
    };
    var _TA_AD = Module["_TA_AD"] = function() {
      return (_TA_AD = Module["_TA_AD"] = Module["asm"]["TA_AD"]).apply(null, arguments);
    };
    var _TA_ADD = Module["_TA_ADD"] = function() {
      return (_TA_ADD = Module["_TA_ADD"] = Module["asm"]["TA_ADD"]).apply(null, arguments);
    };
    var _TA_ADOSC = Module["_TA_ADOSC"] = function() {
      return (_TA_ADOSC = Module["_TA_ADOSC"] = Module["asm"]["TA_ADOSC"]).apply(null, arguments);
    };
    var _TA_ADX = Module["_TA_ADX"] = function() {
      return (_TA_ADX = Module["_TA_ADX"] = Module["asm"]["TA_ADX"]).apply(null, arguments);
    };
    var _TA_ADXR = Module["_TA_ADXR"] = function() {
      return (_TA_ADXR = Module["_TA_ADXR"] = Module["asm"]["TA_ADXR"]).apply(null, arguments);
    };
    var _TA_APO = Module["_TA_APO"] = function() {
      return (_TA_APO = Module["_TA_APO"] = Module["asm"]["TA_APO"]).apply(null, arguments);
    };
    var _TA_MA = Module["_TA_MA"] = function() {
      return (_TA_MA = Module["_TA_MA"] = Module["asm"]["TA_MA"]).apply(null, arguments);
    };
    var _TA_AROON = Module["_TA_AROON"] = function() {
      return (_TA_AROON = Module["_TA_AROON"] = Module["asm"]["TA_AROON"]).apply(null, arguments);
    };
    var _TA_AROONOSC = Module["_TA_AROONOSC"] = function() {
      return (_TA_AROONOSC = Module["_TA_AROONOSC"] = Module["asm"]["TA_AROONOSC"]).apply(null, arguments);
    };
    var _TA_ASIN = Module["_TA_ASIN"] = function() {
      return (_TA_ASIN = Module["_TA_ASIN"] = Module["asm"]["TA_ASIN"]).apply(null, arguments);
    };
    var _TA_ATAN = Module["_TA_ATAN"] = function() {
      return (_TA_ATAN = Module["_TA_ATAN"] = Module["asm"]["TA_ATAN"]).apply(null, arguments);
    };
    var _TA_ATR = Module["_TA_ATR"] = function() {
      return (_TA_ATR = Module["_TA_ATR"] = Module["asm"]["TA_ATR"]).apply(null, arguments);
    };
    var _TA_TRANGE = Module["_TA_TRANGE"] = function() {
      return (_TA_TRANGE = Module["_TA_TRANGE"] = Module["asm"]["TA_TRANGE"]).apply(null, arguments);
    };
    var _TA_AVGDEV = Module["_TA_AVGDEV"] = function() {
      return (_TA_AVGDEV = Module["_TA_AVGDEV"] = Module["asm"]["TA_AVGDEV"]).apply(null, arguments);
    };
    var _TA_AVGPRICE = Module["_TA_AVGPRICE"] = function() {
      return (_TA_AVGPRICE = Module["_TA_AVGPRICE"] = Module["asm"]["TA_AVGPRICE"]).apply(null, arguments);
    };
    var _TA_BBANDS = Module["_TA_BBANDS"] = function() {
      return (_TA_BBANDS = Module["_TA_BBANDS"] = Module["asm"]["TA_BBANDS"]).apply(null, arguments);
    };
    var _TA_STDDEV = Module["_TA_STDDEV"] = function() {
      return (_TA_STDDEV = Module["_TA_STDDEV"] = Module["asm"]["TA_STDDEV"]).apply(null, arguments);
    };
    var _TA_BETA = Module["_TA_BETA"] = function() {
      return (_TA_BETA = Module["_TA_BETA"] = Module["asm"]["TA_BETA"]).apply(null, arguments);
    };
    var _TA_BOP = Module["_TA_BOP"] = function() {
      return (_TA_BOP = Module["_TA_BOP"] = Module["asm"]["TA_BOP"]).apply(null, arguments);
    };
    var _TA_CCI = Module["_TA_CCI"] = function() {
      return (_TA_CCI = Module["_TA_CCI"] = Module["asm"]["TA_CCI"]).apply(null, arguments);
    };
    var _TA_CDL2CROWS = Module["_TA_CDL2CROWS"] = function() {
      return (_TA_CDL2CROWS = Module["_TA_CDL2CROWS"] = Module["asm"]["TA_CDL2CROWS"]).apply(null, arguments);
    };
    var _TA_CDL3BLACKCROWS = Module["_TA_CDL3BLACKCROWS"] = function() {
      return (_TA_CDL3BLACKCROWS = Module["_TA_CDL3BLACKCROWS"] = Module["asm"]["TA_CDL3BLACKCROWS"]).apply(null, arguments);
    };
    var _TA_CDL3INSIDE = Module["_TA_CDL3INSIDE"] = function() {
      return (_TA_CDL3INSIDE = Module["_TA_CDL3INSIDE"] = Module["asm"]["TA_CDL3INSIDE"]).apply(null, arguments);
    };
    var _TA_CDL3LINESTRIKE = Module["_TA_CDL3LINESTRIKE"] = function() {
      return (_TA_CDL3LINESTRIKE = Module["_TA_CDL3LINESTRIKE"] = Module["asm"]["TA_CDL3LINESTRIKE"]).apply(null, arguments);
    };
    var _TA_CDL3OUTSIDE = Module["_TA_CDL3OUTSIDE"] = function() {
      return (_TA_CDL3OUTSIDE = Module["_TA_CDL3OUTSIDE"] = Module["asm"]["TA_CDL3OUTSIDE"]).apply(null, arguments);
    };
    var _TA_CDL3STARSINSOUTH = Module["_TA_CDL3STARSINSOUTH"] = function() {
      return (_TA_CDL3STARSINSOUTH = Module["_TA_CDL3STARSINSOUTH"] = Module["asm"]["TA_CDL3STARSINSOUTH"]).apply(null, arguments);
    };
    var _TA_CDL3WHITESOLDIERS = Module["_TA_CDL3WHITESOLDIERS"] = function() {
      return (_TA_CDL3WHITESOLDIERS = Module["_TA_CDL3WHITESOLDIERS"] = Module["asm"]["TA_CDL3WHITESOLDIERS"]).apply(null, arguments);
    };
    var _TA_CDLABANDONEDBABY = Module["_TA_CDLABANDONEDBABY"] = function() {
      return (_TA_CDLABANDONEDBABY = Module["_TA_CDLABANDONEDBABY"] = Module["asm"]["TA_CDLABANDONEDBABY"]).apply(null, arguments);
    };
    var _TA_CDLADVANCEBLOCK = Module["_TA_CDLADVANCEBLOCK"] = function() {
      return (_TA_CDLADVANCEBLOCK = Module["_TA_CDLADVANCEBLOCK"] = Module["asm"]["TA_CDLADVANCEBLOCK"]).apply(null, arguments);
    };
    var _TA_CDLBELTHOLD = Module["_TA_CDLBELTHOLD"] = function() {
      return (_TA_CDLBELTHOLD = Module["_TA_CDLBELTHOLD"] = Module["asm"]["TA_CDLBELTHOLD"]).apply(null, arguments);
    };
    var _TA_CDLBREAKAWAY = Module["_TA_CDLBREAKAWAY"] = function() {
      return (_TA_CDLBREAKAWAY = Module["_TA_CDLBREAKAWAY"] = Module["asm"]["TA_CDLBREAKAWAY"]).apply(null, arguments);
    };
    var _TA_CDLCLOSINGMARUBOZU = Module["_TA_CDLCLOSINGMARUBOZU"] = function() {
      return (_TA_CDLCLOSINGMARUBOZU = Module["_TA_CDLCLOSINGMARUBOZU"] = Module["asm"]["TA_CDLCLOSINGMARUBOZU"]).apply(null, arguments);
    };
    var _TA_CDLCONCEALBABYSWALL = Module["_TA_CDLCONCEALBABYSWALL"] = function() {
      return (_TA_CDLCONCEALBABYSWALL = Module["_TA_CDLCONCEALBABYSWALL"] = Module["asm"]["TA_CDLCONCEALBABYSWALL"]).apply(null, arguments);
    };
    var _TA_CDLCOUNTERATTACK = Module["_TA_CDLCOUNTERATTACK"] = function() {
      return (_TA_CDLCOUNTERATTACK = Module["_TA_CDLCOUNTERATTACK"] = Module["asm"]["TA_CDLCOUNTERATTACK"]).apply(null, arguments);
    };
    var _TA_CDLDARKCLOUDCOVER = Module["_TA_CDLDARKCLOUDCOVER"] = function() {
      return (_TA_CDLDARKCLOUDCOVER = Module["_TA_CDLDARKCLOUDCOVER"] = Module["asm"]["TA_CDLDARKCLOUDCOVER"]).apply(null, arguments);
    };
    var _TA_CDLDOJI = Module["_TA_CDLDOJI"] = function() {
      return (_TA_CDLDOJI = Module["_TA_CDLDOJI"] = Module["asm"]["TA_CDLDOJI"]).apply(null, arguments);
    };
    var _TA_CDLDOJISTAR = Module["_TA_CDLDOJISTAR"] = function() {
      return (_TA_CDLDOJISTAR = Module["_TA_CDLDOJISTAR"] = Module["asm"]["TA_CDLDOJISTAR"]).apply(null, arguments);
    };
    var _TA_CDLDRAGONFLYDOJI = Module["_TA_CDLDRAGONFLYDOJI"] = function() {
      return (_TA_CDLDRAGONFLYDOJI = Module["_TA_CDLDRAGONFLYDOJI"] = Module["asm"]["TA_CDLDRAGONFLYDOJI"]).apply(null, arguments);
    };
    var _TA_CDLENGULFING = Module["_TA_CDLENGULFING"] = function() {
      return (_TA_CDLENGULFING = Module["_TA_CDLENGULFING"] = Module["asm"]["TA_CDLENGULFING"]).apply(null, arguments);
    };
    var _TA_CDLEVENINGDOJISTAR = Module["_TA_CDLEVENINGDOJISTAR"] = function() {
      return (_TA_CDLEVENINGDOJISTAR = Module["_TA_CDLEVENINGDOJISTAR"] = Module["asm"]["TA_CDLEVENINGDOJISTAR"]).apply(null, arguments);
    };
    var _TA_CDLEVENINGSTAR = Module["_TA_CDLEVENINGSTAR"] = function() {
      return (_TA_CDLEVENINGSTAR = Module["_TA_CDLEVENINGSTAR"] = Module["asm"]["TA_CDLEVENINGSTAR"]).apply(null, arguments);
    };
    var _TA_CDLGAPSIDESIDEWHITE = Module["_TA_CDLGAPSIDESIDEWHITE"] = function() {
      return (_TA_CDLGAPSIDESIDEWHITE = Module["_TA_CDLGAPSIDESIDEWHITE"] = Module["asm"]["TA_CDLGAPSIDESIDEWHITE"]).apply(null, arguments);
    };
    var _TA_CDLGRAVESTONEDOJI = Module["_TA_CDLGRAVESTONEDOJI"] = function() {
      return (_TA_CDLGRAVESTONEDOJI = Module["_TA_CDLGRAVESTONEDOJI"] = Module["asm"]["TA_CDLGRAVESTONEDOJI"]).apply(null, arguments);
    };
    var _TA_CDLHAMMER = Module["_TA_CDLHAMMER"] = function() {
      return (_TA_CDLHAMMER = Module["_TA_CDLHAMMER"] = Module["asm"]["TA_CDLHAMMER"]).apply(null, arguments);
    };
    var _TA_CDLHANGINGMAN = Module["_TA_CDLHANGINGMAN"] = function() {
      return (_TA_CDLHANGINGMAN = Module["_TA_CDLHANGINGMAN"] = Module["asm"]["TA_CDLHANGINGMAN"]).apply(null, arguments);
    };
    var _TA_CDLHARAMI = Module["_TA_CDLHARAMI"] = function() {
      return (_TA_CDLHARAMI = Module["_TA_CDLHARAMI"] = Module["asm"]["TA_CDLHARAMI"]).apply(null, arguments);
    };
    var _TA_CDLHARAMICROSS = Module["_TA_CDLHARAMICROSS"] = function() {
      return (_TA_CDLHARAMICROSS = Module["_TA_CDLHARAMICROSS"] = Module["asm"]["TA_CDLHARAMICROSS"]).apply(null, arguments);
    };
    var _TA_CDLHIGHWAVE = Module["_TA_CDLHIGHWAVE"] = function() {
      return (_TA_CDLHIGHWAVE = Module["_TA_CDLHIGHWAVE"] = Module["asm"]["TA_CDLHIGHWAVE"]).apply(null, arguments);
    };
    var _TA_CDLHIKKAKE = Module["_TA_CDLHIKKAKE"] = function() {
      return (_TA_CDLHIKKAKE = Module["_TA_CDLHIKKAKE"] = Module["asm"]["TA_CDLHIKKAKE"]).apply(null, arguments);
    };
    var _TA_CDLHIKKAKEMOD = Module["_TA_CDLHIKKAKEMOD"] = function() {
      return (_TA_CDLHIKKAKEMOD = Module["_TA_CDLHIKKAKEMOD"] = Module["asm"]["TA_CDLHIKKAKEMOD"]).apply(null, arguments);
    };
    var _TA_CDLHOMINGPIGEON = Module["_TA_CDLHOMINGPIGEON"] = function() {
      return (_TA_CDLHOMINGPIGEON = Module["_TA_CDLHOMINGPIGEON"] = Module["asm"]["TA_CDLHOMINGPIGEON"]).apply(null, arguments);
    };
    var _TA_CDLIDENTICAL3CROWS = Module["_TA_CDLIDENTICAL3CROWS"] = function() {
      return (_TA_CDLIDENTICAL3CROWS = Module["_TA_CDLIDENTICAL3CROWS"] = Module["asm"]["TA_CDLIDENTICAL3CROWS"]).apply(null, arguments);
    };
    var _TA_CDLINNECK = Module["_TA_CDLINNECK"] = function() {
      return (_TA_CDLINNECK = Module["_TA_CDLINNECK"] = Module["asm"]["TA_CDLINNECK"]).apply(null, arguments);
    };
    var _TA_CDLINVERTEDHAMMER = Module["_TA_CDLINVERTEDHAMMER"] = function() {
      return (_TA_CDLINVERTEDHAMMER = Module["_TA_CDLINVERTEDHAMMER"] = Module["asm"]["TA_CDLINVERTEDHAMMER"]).apply(null, arguments);
    };
    var _TA_CDLKICKINGBYLENGTH = Module["_TA_CDLKICKINGBYLENGTH"] = function() {
      return (_TA_CDLKICKINGBYLENGTH = Module["_TA_CDLKICKINGBYLENGTH"] = Module["asm"]["TA_CDLKICKINGBYLENGTH"]).apply(null, arguments);
    };
    var _TA_CDLKICKING = Module["_TA_CDLKICKING"] = function() {
      return (_TA_CDLKICKING = Module["_TA_CDLKICKING"] = Module["asm"]["TA_CDLKICKING"]).apply(null, arguments);
    };
    var _TA_CDLLADDERBOTTOM = Module["_TA_CDLLADDERBOTTOM"] = function() {
      return (_TA_CDLLADDERBOTTOM = Module["_TA_CDLLADDERBOTTOM"] = Module["asm"]["TA_CDLLADDERBOTTOM"]).apply(null, arguments);
    };
    var _TA_CDLLONGLEGGEDDOJI = Module["_TA_CDLLONGLEGGEDDOJI"] = function() {
      return (_TA_CDLLONGLEGGEDDOJI = Module["_TA_CDLLONGLEGGEDDOJI"] = Module["asm"]["TA_CDLLONGLEGGEDDOJI"]).apply(null, arguments);
    };
    var _TA_CDLLONGLINE = Module["_TA_CDLLONGLINE"] = function() {
      return (_TA_CDLLONGLINE = Module["_TA_CDLLONGLINE"] = Module["asm"]["TA_CDLLONGLINE"]).apply(null, arguments);
    };
    var _TA_CDLMARUBOZU = Module["_TA_CDLMARUBOZU"] = function() {
      return (_TA_CDLMARUBOZU = Module["_TA_CDLMARUBOZU"] = Module["asm"]["TA_CDLMARUBOZU"]).apply(null, arguments);
    };
    var _TA_CDLMATCHINGLOW = Module["_TA_CDLMATCHINGLOW"] = function() {
      return (_TA_CDLMATCHINGLOW = Module["_TA_CDLMATCHINGLOW"] = Module["asm"]["TA_CDLMATCHINGLOW"]).apply(null, arguments);
    };
    var _TA_CDLMATHOLD = Module["_TA_CDLMATHOLD"] = function() {
      return (_TA_CDLMATHOLD = Module["_TA_CDLMATHOLD"] = Module["asm"]["TA_CDLMATHOLD"]).apply(null, arguments);
    };
    var _TA_CDLMORNINGDOJISTAR = Module["_TA_CDLMORNINGDOJISTAR"] = function() {
      return (_TA_CDLMORNINGDOJISTAR = Module["_TA_CDLMORNINGDOJISTAR"] = Module["asm"]["TA_CDLMORNINGDOJISTAR"]).apply(null, arguments);
    };
    var _TA_CDLMORNINGSTAR = Module["_TA_CDLMORNINGSTAR"] = function() {
      return (_TA_CDLMORNINGSTAR = Module["_TA_CDLMORNINGSTAR"] = Module["asm"]["TA_CDLMORNINGSTAR"]).apply(null, arguments);
    };
    var _TA_CDLONNECK = Module["_TA_CDLONNECK"] = function() {
      return (_TA_CDLONNECK = Module["_TA_CDLONNECK"] = Module["asm"]["TA_CDLONNECK"]).apply(null, arguments);
    };
    var _TA_CDLPIERCING = Module["_TA_CDLPIERCING"] = function() {
      return (_TA_CDLPIERCING = Module["_TA_CDLPIERCING"] = Module["asm"]["TA_CDLPIERCING"]).apply(null, arguments);
    };
    var _TA_CDLRICKSHAWMAN = Module["_TA_CDLRICKSHAWMAN"] = function() {
      return (_TA_CDLRICKSHAWMAN = Module["_TA_CDLRICKSHAWMAN"] = Module["asm"]["TA_CDLRICKSHAWMAN"]).apply(null, arguments);
    };
    var _TA_CDLRISEFALL3METHODS = Module["_TA_CDLRISEFALL3METHODS"] = function() {
      return (_TA_CDLRISEFALL3METHODS = Module["_TA_CDLRISEFALL3METHODS"] = Module["asm"]["TA_CDLRISEFALL3METHODS"]).apply(null, arguments);
    };
    var _TA_CDLSEPARATINGLINES = Module["_TA_CDLSEPARATINGLINES"] = function() {
      return (_TA_CDLSEPARATINGLINES = Module["_TA_CDLSEPARATINGLINES"] = Module["asm"]["TA_CDLSEPARATINGLINES"]).apply(null, arguments);
    };
    var _TA_CDLSHOOTINGSTAR = Module["_TA_CDLSHOOTINGSTAR"] = function() {
      return (_TA_CDLSHOOTINGSTAR = Module["_TA_CDLSHOOTINGSTAR"] = Module["asm"]["TA_CDLSHOOTINGSTAR"]).apply(null, arguments);
    };
    var _TA_CDLSHORTLINE = Module["_TA_CDLSHORTLINE"] = function() {
      return (_TA_CDLSHORTLINE = Module["_TA_CDLSHORTLINE"] = Module["asm"]["TA_CDLSHORTLINE"]).apply(null, arguments);
    };
    var _TA_CDLSPINNINGTOP = Module["_TA_CDLSPINNINGTOP"] = function() {
      return (_TA_CDLSPINNINGTOP = Module["_TA_CDLSPINNINGTOP"] = Module["asm"]["TA_CDLSPINNINGTOP"]).apply(null, arguments);
    };
    var _TA_CDLSTALLEDPATTERN = Module["_TA_CDLSTALLEDPATTERN"] = function() {
      return (_TA_CDLSTALLEDPATTERN = Module["_TA_CDLSTALLEDPATTERN"] = Module["asm"]["TA_CDLSTALLEDPATTERN"]).apply(null, arguments);
    };
    var _TA_CDLSTICKSANDWICH = Module["_TA_CDLSTICKSANDWICH"] = function() {
      return (_TA_CDLSTICKSANDWICH = Module["_TA_CDLSTICKSANDWICH"] = Module["asm"]["TA_CDLSTICKSANDWICH"]).apply(null, arguments);
    };
    var _TA_CDLTAKURI = Module["_TA_CDLTAKURI"] = function() {
      return (_TA_CDLTAKURI = Module["_TA_CDLTAKURI"] = Module["asm"]["TA_CDLTAKURI"]).apply(null, arguments);
    };
    var _TA_CDLTASUKIGAP = Module["_TA_CDLTASUKIGAP"] = function() {
      return (_TA_CDLTASUKIGAP = Module["_TA_CDLTASUKIGAP"] = Module["asm"]["TA_CDLTASUKIGAP"]).apply(null, arguments);
    };
    var _TA_CDLTHRUSTING = Module["_TA_CDLTHRUSTING"] = function() {
      return (_TA_CDLTHRUSTING = Module["_TA_CDLTHRUSTING"] = Module["asm"]["TA_CDLTHRUSTING"]).apply(null, arguments);
    };
    var _TA_CDLTRISTAR = Module["_TA_CDLTRISTAR"] = function() {
      return (_TA_CDLTRISTAR = Module["_TA_CDLTRISTAR"] = Module["asm"]["TA_CDLTRISTAR"]).apply(null, arguments);
    };
    var _TA_CDLUNIQUE3RIVER = Module["_TA_CDLUNIQUE3RIVER"] = function() {
      return (_TA_CDLUNIQUE3RIVER = Module["_TA_CDLUNIQUE3RIVER"] = Module["asm"]["TA_CDLUNIQUE3RIVER"]).apply(null, arguments);
    };
    var _TA_CDLUPSIDEGAP2CROWS = Module["_TA_CDLUPSIDEGAP2CROWS"] = function() {
      return (_TA_CDLUPSIDEGAP2CROWS = Module["_TA_CDLUPSIDEGAP2CROWS"] = Module["asm"]["TA_CDLUPSIDEGAP2CROWS"]).apply(null, arguments);
    };
    var _TA_CDLXSIDEGAP3METHODS = Module["_TA_CDLXSIDEGAP3METHODS"] = function() {
      return (_TA_CDLXSIDEGAP3METHODS = Module["_TA_CDLXSIDEGAP3METHODS"] = Module["asm"]["TA_CDLXSIDEGAP3METHODS"]).apply(null, arguments);
    };
    var _TA_CEIL = Module["_TA_CEIL"] = function() {
      return (_TA_CEIL = Module["_TA_CEIL"] = Module["asm"]["TA_CEIL"]).apply(null, arguments);
    };
    var _TA_CMO = Module["_TA_CMO"] = function() {
      return (_TA_CMO = Module["_TA_CMO"] = Module["asm"]["TA_CMO"]).apply(null, arguments);
    };
    var _TA_CORREL = Module["_TA_CORREL"] = function() {
      return (_TA_CORREL = Module["_TA_CORREL"] = Module["asm"]["TA_CORREL"]).apply(null, arguments);
    };
    var _TA_COS = Module["_TA_COS"] = function() {
      return (_TA_COS = Module["_TA_COS"] = Module["asm"]["TA_COS"]).apply(null, arguments);
    };
    var _TA_COSH = Module["_TA_COSH"] = function() {
      return (_TA_COSH = Module["_TA_COSH"] = Module["asm"]["TA_COSH"]).apply(null, arguments);
    };
    var _TA_DEMA = Module["_TA_DEMA"] = function() {
      return (_TA_DEMA = Module["_TA_DEMA"] = Module["asm"]["TA_DEMA"]).apply(null, arguments);
    };
    var _TA_DIV = Module["_TA_DIV"] = function() {
      return (_TA_DIV = Module["_TA_DIV"] = Module["asm"]["TA_DIV"]).apply(null, arguments);
    };
    var _TA_DX = Module["_TA_DX"] = function() {
      return (_TA_DX = Module["_TA_DX"] = Module["asm"]["TA_DX"]).apply(null, arguments);
    };
    var _TA_EMA = Module["_TA_EMA"] = function() {
      return (_TA_EMA = Module["_TA_EMA"] = Module["asm"]["TA_EMA"]).apply(null, arguments);
    };
    var _TA_EXP = Module["_TA_EXP"] = function() {
      return (_TA_EXP = Module["_TA_EXP"] = Module["asm"]["TA_EXP"]).apply(null, arguments);
    };
    var _TA_FLOOR = Module["_TA_FLOOR"] = function() {
      return (_TA_FLOOR = Module["_TA_FLOOR"] = Module["asm"]["TA_FLOOR"]).apply(null, arguments);
    };
    var _TA_HT_DCPERIOD = Module["_TA_HT_DCPERIOD"] = function() {
      return (_TA_HT_DCPERIOD = Module["_TA_HT_DCPERIOD"] = Module["asm"]["TA_HT_DCPERIOD"]).apply(null, arguments);
    };
    var _TA_HT_DCPHASE = Module["_TA_HT_DCPHASE"] = function() {
      return (_TA_HT_DCPHASE = Module["_TA_HT_DCPHASE"] = Module["asm"]["TA_HT_DCPHASE"]).apply(null, arguments);
    };
    var _TA_HT_PHASOR = Module["_TA_HT_PHASOR"] = function() {
      return (_TA_HT_PHASOR = Module["_TA_HT_PHASOR"] = Module["asm"]["TA_HT_PHASOR"]).apply(null, arguments);
    };
    var _TA_HT_SINE = Module["_TA_HT_SINE"] = function() {
      return (_TA_HT_SINE = Module["_TA_HT_SINE"] = Module["asm"]["TA_HT_SINE"]).apply(null, arguments);
    };
    var _TA_HT_TRENDLINE = Module["_TA_HT_TRENDLINE"] = function() {
      return (_TA_HT_TRENDLINE = Module["_TA_HT_TRENDLINE"] = Module["asm"]["TA_HT_TRENDLINE"]).apply(null, arguments);
    };
    var _TA_HT_TRENDMODE = Module["_TA_HT_TRENDMODE"] = function() {
      return (_TA_HT_TRENDMODE = Module["_TA_HT_TRENDMODE"] = Module["asm"]["TA_HT_TRENDMODE"]).apply(null, arguments);
    };
    var _TA_IMI = Module["_TA_IMI"] = function() {
      return (_TA_IMI = Module["_TA_IMI"] = Module["asm"]["TA_IMI"]).apply(null, arguments);
    };
    var _TA_KAMA = Module["_TA_KAMA"] = function() {
      return (_TA_KAMA = Module["_TA_KAMA"] = Module["asm"]["TA_KAMA"]).apply(null, arguments);
    };
    var _TA_LINEARREG_ANGLE = Module["_TA_LINEARREG_ANGLE"] = function() {
      return (_TA_LINEARREG_ANGLE = Module["_TA_LINEARREG_ANGLE"] = Module["asm"]["TA_LINEARREG_ANGLE"]).apply(null, arguments);
    };
    var _TA_LINEARREG = Module["_TA_LINEARREG"] = function() {
      return (_TA_LINEARREG = Module["_TA_LINEARREG"] = Module["asm"]["TA_LINEARREG"]).apply(null, arguments);
    };
    var _TA_LINEARREG_INTERCEPT = Module["_TA_LINEARREG_INTERCEPT"] = function() {
      return (_TA_LINEARREG_INTERCEPT = Module["_TA_LINEARREG_INTERCEPT"] = Module["asm"]["TA_LINEARREG_INTERCEPT"]).apply(null, arguments);
    };
    var _TA_LINEARREG_SLOPE = Module["_TA_LINEARREG_SLOPE"] = function() {
      return (_TA_LINEARREG_SLOPE = Module["_TA_LINEARREG_SLOPE"] = Module["asm"]["TA_LINEARREG_SLOPE"]).apply(null, arguments);
    };
    var _TA_LN = Module["_TA_LN"] = function() {
      return (_TA_LN = Module["_TA_LN"] = Module["asm"]["TA_LN"]).apply(null, arguments);
    };
    var _TA_LOG10 = Module["_TA_LOG10"] = function() {
      return (_TA_LOG10 = Module["_TA_LOG10"] = Module["asm"]["TA_LOG10"]).apply(null, arguments);
    };
    var _TA_WMA = Module["_TA_WMA"] = function() {
      return (_TA_WMA = Module["_TA_WMA"] = Module["asm"]["TA_WMA"]).apply(null, arguments);
    };
    var _TA_TEMA = Module["_TA_TEMA"] = function() {
      return (_TA_TEMA = Module["_TA_TEMA"] = Module["asm"]["TA_TEMA"]).apply(null, arguments);
    };
    var _TA_TRIMA = Module["_TA_TRIMA"] = function() {
      return (_TA_TRIMA = Module["_TA_TRIMA"] = Module["asm"]["TA_TRIMA"]).apply(null, arguments);
    };
    var _TA_MAMA = Module["_TA_MAMA"] = function() {
      return (_TA_MAMA = Module["_TA_MAMA"] = Module["asm"]["TA_MAMA"]).apply(null, arguments);
    };
    var _TA_T3 = Module["_TA_T3"] = function() {
      return (_TA_T3 = Module["_TA_T3"] = Module["asm"]["TA_T3"]).apply(null, arguments);
    };
    var _TA_MACD = Module["_TA_MACD"] = function() {
      return (_TA_MACD = Module["_TA_MACD"] = Module["asm"]["TA_MACD"]).apply(null, arguments);
    };
    var _TA_MACDEXT = Module["_TA_MACDEXT"] = function() {
      return (_TA_MACDEXT = Module["_TA_MACDEXT"] = Module["asm"]["TA_MACDEXT"]).apply(null, arguments);
    };
    var _TA_MACDFIX = Module["_TA_MACDFIX"] = function() {
      return (_TA_MACDFIX = Module["_TA_MACDFIX"] = Module["asm"]["TA_MACDFIX"]).apply(null, arguments);
    };
    var _TA_MAVP = Module["_TA_MAVP"] = function() {
      return (_TA_MAVP = Module["_TA_MAVP"] = Module["asm"]["TA_MAVP"]).apply(null, arguments);
    };
    var _TA_MAX = Module["_TA_MAX"] = function() {
      return (_TA_MAX = Module["_TA_MAX"] = Module["asm"]["TA_MAX"]).apply(null, arguments);
    };
    var _TA_MAXINDEX = Module["_TA_MAXINDEX"] = function() {
      return (_TA_MAXINDEX = Module["_TA_MAXINDEX"] = Module["asm"]["TA_MAXINDEX"]).apply(null, arguments);
    };
    var _TA_MEDPRICE = Module["_TA_MEDPRICE"] = function() {
      return (_TA_MEDPRICE = Module["_TA_MEDPRICE"] = Module["asm"]["TA_MEDPRICE"]).apply(null, arguments);
    };
    var _TA_MFI = Module["_TA_MFI"] = function() {
      return (_TA_MFI = Module["_TA_MFI"] = Module["asm"]["TA_MFI"]).apply(null, arguments);
    };
    var _TA_MIDPOINT = Module["_TA_MIDPOINT"] = function() {
      return (_TA_MIDPOINT = Module["_TA_MIDPOINT"] = Module["asm"]["TA_MIDPOINT"]).apply(null, arguments);
    };
    var _TA_MIDPRICE = Module["_TA_MIDPRICE"] = function() {
      return (_TA_MIDPRICE = Module["_TA_MIDPRICE"] = Module["asm"]["TA_MIDPRICE"]).apply(null, arguments);
    };
    var _TA_MIN = Module["_TA_MIN"] = function() {
      return (_TA_MIN = Module["_TA_MIN"] = Module["asm"]["TA_MIN"]).apply(null, arguments);
    };
    var _TA_MININDEX = Module["_TA_MININDEX"] = function() {
      return (_TA_MININDEX = Module["_TA_MININDEX"] = Module["asm"]["TA_MININDEX"]).apply(null, arguments);
    };
    var _TA_MINMAX = Module["_TA_MINMAX"] = function() {
      return (_TA_MINMAX = Module["_TA_MINMAX"] = Module["asm"]["TA_MINMAX"]).apply(null, arguments);
    };
    var _TA_MINMAXINDEX = Module["_TA_MINMAXINDEX"] = function() {
      return (_TA_MINMAXINDEX = Module["_TA_MINMAXINDEX"] = Module["asm"]["TA_MINMAXINDEX"]).apply(null, arguments);
    };
    var _TA_MINUS_DI = Module["_TA_MINUS_DI"] = function() {
      return (_TA_MINUS_DI = Module["_TA_MINUS_DI"] = Module["asm"]["TA_MINUS_DI"]).apply(null, arguments);
    };
    var _TA_MINUS_DM = Module["_TA_MINUS_DM"] = function() {
      return (_TA_MINUS_DM = Module["_TA_MINUS_DM"] = Module["asm"]["TA_MINUS_DM"]).apply(null, arguments);
    };
    var _TA_MOM = Module["_TA_MOM"] = function() {
      return (_TA_MOM = Module["_TA_MOM"] = Module["asm"]["TA_MOM"]).apply(null, arguments);
    };
    var _TA_MULT = Module["_TA_MULT"] = function() {
      return (_TA_MULT = Module["_TA_MULT"] = Module["asm"]["TA_MULT"]).apply(null, arguments);
    };
    var _TA_NATR = Module["_TA_NATR"] = function() {
      return (_TA_NATR = Module["_TA_NATR"] = Module["asm"]["TA_NATR"]).apply(null, arguments);
    };
    var _TA_OBV = Module["_TA_OBV"] = function() {
      return (_TA_OBV = Module["_TA_OBV"] = Module["asm"]["TA_OBV"]).apply(null, arguments);
    };
    var _TA_PLUS_DI = Module["_TA_PLUS_DI"] = function() {
      return (_TA_PLUS_DI = Module["_TA_PLUS_DI"] = Module["asm"]["TA_PLUS_DI"]).apply(null, arguments);
    };
    var _TA_PLUS_DM = Module["_TA_PLUS_DM"] = function() {
      return (_TA_PLUS_DM = Module["_TA_PLUS_DM"] = Module["asm"]["TA_PLUS_DM"]).apply(null, arguments);
    };
    var _TA_PPO = Module["_TA_PPO"] = function() {
      return (_TA_PPO = Module["_TA_PPO"] = Module["asm"]["TA_PPO"]).apply(null, arguments);
    };
    var _TA_ROC = Module["_TA_ROC"] = function() {
      return (_TA_ROC = Module["_TA_ROC"] = Module["asm"]["TA_ROC"]).apply(null, arguments);
    };
    var _TA_ROCP = Module["_TA_ROCP"] = function() {
      return (_TA_ROCP = Module["_TA_ROCP"] = Module["asm"]["TA_ROCP"]).apply(null, arguments);
    };
    var _TA_ROCR100 = Module["_TA_ROCR100"] = function() {
      return (_TA_ROCR100 = Module["_TA_ROCR100"] = Module["asm"]["TA_ROCR100"]).apply(null, arguments);
    };
    var _TA_ROCR = Module["_TA_ROCR"] = function() {
      return (_TA_ROCR = Module["_TA_ROCR"] = Module["asm"]["TA_ROCR"]).apply(null, arguments);
    };
    var _TA_RSI = Module["_TA_RSI"] = function() {
      return (_TA_RSI = Module["_TA_RSI"] = Module["asm"]["TA_RSI"]).apply(null, arguments);
    };
    var _TA_SAR = Module["_TA_SAR"] = function() {
      return (_TA_SAR = Module["_TA_SAR"] = Module["asm"]["TA_SAR"]).apply(null, arguments);
    };
    var _TA_SAREXT = Module["_TA_SAREXT"] = function() {
      return (_TA_SAREXT = Module["_TA_SAREXT"] = Module["asm"]["TA_SAREXT"]).apply(null, arguments);
    };
    var _TA_SIN = Module["_TA_SIN"] = function() {
      return (_TA_SIN = Module["_TA_SIN"] = Module["asm"]["TA_SIN"]).apply(null, arguments);
    };
    var _TA_SINH = Module["_TA_SINH"] = function() {
      return (_TA_SINH = Module["_TA_SINH"] = Module["asm"]["TA_SINH"]).apply(null, arguments);
    };
    var _TA_SQRT = Module["_TA_SQRT"] = function() {
      return (_TA_SQRT = Module["_TA_SQRT"] = Module["asm"]["TA_SQRT"]).apply(null, arguments);
    };
    var _TA_STOCH = Module["_TA_STOCH"] = function() {
      return (_TA_STOCH = Module["_TA_STOCH"] = Module["asm"]["TA_STOCH"]).apply(null, arguments);
    };
    var _TA_STOCHF = Module["_TA_STOCHF"] = function() {
      return (_TA_STOCHF = Module["_TA_STOCHF"] = Module["asm"]["TA_STOCHF"]).apply(null, arguments);
    };
    var _TA_STOCHRSI = Module["_TA_STOCHRSI"] = function() {
      return (_TA_STOCHRSI = Module["_TA_STOCHRSI"] = Module["asm"]["TA_STOCHRSI"]).apply(null, arguments);
    };
    var _TA_SUB = Module["_TA_SUB"] = function() {
      return (_TA_SUB = Module["_TA_SUB"] = Module["asm"]["TA_SUB"]).apply(null, arguments);
    };
    var _TA_SUM = Module["_TA_SUM"] = function() {
      return (_TA_SUM = Module["_TA_SUM"] = Module["asm"]["TA_SUM"]).apply(null, arguments);
    };
    var _TA_TAN = Module["_TA_TAN"] = function() {
      return (_TA_TAN = Module["_TA_TAN"] = Module["asm"]["TA_TAN"]).apply(null, arguments);
    };
    var _TA_TANH = Module["_TA_TANH"] = function() {
      return (_TA_TANH = Module["_TA_TANH"] = Module["asm"]["TA_TANH"]).apply(null, arguments);
    };
    var _TA_TRIX = Module["_TA_TRIX"] = function() {
      return (_TA_TRIX = Module["_TA_TRIX"] = Module["asm"]["TA_TRIX"]).apply(null, arguments);
    };
    var _TA_TSF = Module["_TA_TSF"] = function() {
      return (_TA_TSF = Module["_TA_TSF"] = Module["asm"]["TA_TSF"]).apply(null, arguments);
    };
    var _TA_TYPPRICE = Module["_TA_TYPPRICE"] = function() {
      return (_TA_TYPPRICE = Module["_TA_TYPPRICE"] = Module["asm"]["TA_TYPPRICE"]).apply(null, arguments);
    };
    var _TA_ULTOSC = Module["_TA_ULTOSC"] = function() {
      return (_TA_ULTOSC = Module["_TA_ULTOSC"] = Module["asm"]["TA_ULTOSC"]).apply(null, arguments);
    };
    var _TA_VAR = Module["_TA_VAR"] = function() {
      return (_TA_VAR = Module["_TA_VAR"] = Module["asm"]["TA_VAR"]).apply(null, arguments);
    };
    var _TA_WCLPRICE = Module["_TA_WCLPRICE"] = function() {
      return (_TA_WCLPRICE = Module["_TA_WCLPRICE"] = Module["asm"]["TA_WCLPRICE"]).apply(null, arguments);
    };
    var _TA_WILLR = Module["_TA_WILLR"] = function() {
      return (_TA_WILLR = Module["_TA_WILLR"] = Module["asm"]["TA_WILLR"]).apply(null, arguments);
    };
...
function callFunc(api, params) {
  ...
  const ccallArgsLen = 2 + api.inputs.length + api.options.length + 2 + api.outputs.length;
  ...
  for (const { name, defaultValue, range } of api.options) {
    ...
    } else if (range && (params[name] < range.min || params[name] > range.max)) {
  ...
  const result = outputs.reduce((result2, current) => {
    result2[current.name] = Array.from(current.array.data);
    return result2;
  }, {});
  if (retCode === 0) {
    return result;
...
function init(wasmBinaryFilePath) {
  ...
  const locateFile = wasmBinaryFilePath ? () => wasmBinaryFilePath : void 0;
  return __INIT__({ locateFile }).then((Module) => TA_WASM = Module).catch((e) => {
...
//# sourceMappingURL=talib-web.js.map
